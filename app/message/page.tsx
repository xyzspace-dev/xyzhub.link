...
export default function ContactPage() {
    ...
    return (
        <main className="min-h-[80vh] flex items-center justify-center">
            ...
            <div className={"z-20 absolute border-4 p-20 rounded-2xl bg-zinc-900 text-red-900 font-bold text-2xl"}>
            ...
            <motion.section
                ...
                className="w-full max-w-2xl bg-zinc/90 dark:bg-zinc-900/80 rounded-2xl shadow-xl p-8 backdrop-blur-lg blur-xs"
            >
                <motion.h1
                ...
                >
                    <div className="flex items-center gap-2 text-zinc-700 dark:text-zinc-200">
                        <Mail className="w-5 h-5 text-zinc-500"/> message@jespersen.zip
                    </div>
                    <div className="flex items-center gap-2 text-zinc-700 dark:text-zinc-200">
                ...
                >
                    <div className="gap-4 flex flex-col sm:flex-auto">
                        <div
                            className="bg-zinc-600 dark:bg-zinc-800/70 border-none transition inline-flex justify-center w-full items-center rounded-md shadow-sm">
                            <User className="ml-2"/>
                            <Input
                                type="text"
                                name="name"
